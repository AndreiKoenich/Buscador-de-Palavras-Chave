...
int main ()
{
    ...
    consulta_arvoreAVL (raiz, arquivo_consultas, arquivo_saida); /* Realiza a consulta das palavras do arquivo de consultas na arvore e as imprime no arquivo de saida, com seus respectivos tweets. */
